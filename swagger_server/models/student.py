...
class Student(Model):
    ...
    """
    def __init__(self, student_id: float=None, first_name: str=None, last_name: str=None, grade_record: List[GradeRecord]=None):  # noqa: E501
    ...
    @grade_record.setter
    def grade_record(self, grade_record: List[GradeRecord]):
